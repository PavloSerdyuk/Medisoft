...
namespace lab6.Controllers
{
    ...
    public class TrainersController : ControllerBase
    {
        ...
        public TrainersController(FootballClubDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Trainer>> PostTrainer(Trainer trainer)
        {
            ...
            return CreatedAtAction("GetTrainer", new { id = trainer.EmployeeId }, trainer);
        }
        ...
        {
            return _context.Trainers.Any(e => e.EmployeeId == id);
        }
    }
}
